    ...
    return (
        <div {...props}>
            <footer className="footer footer-center bg-primary text-primary-content p-10">
                <aside>
                    <img src={logogImage} className={'w-16 h-16 object-cover rounded-full'} />
                    <p className="font-bold">
                        Loose Screw Community Token
                        <br/>
                        Providing reliable Community Will since Nov 2024
                    </p>
                ...
                <nav>
                    <div className="grid grid-flow-col gap-4">
                        <a href={'https://www.x.com/'}>
                            <FontAwesomeIcon icon={faX} className="w-16 h-16 text-black" />
                        </a>
                        <a>
